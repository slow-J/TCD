...
int main( int argc, char *argv[] )
{
  ...
  static const char *encryptionSelect = "encryption";
  static const char *decryptionSelect = "decryption";
  unsigned int i, n;
  int mode, lastn;
  size_t keylen;
  ...
  */
  ...
  char *modeSelect = argv[1];
  char *encr = strcasestr(encryptionSelect, modeSelect);
  if (encr == NULL)
  {
    char *decr = strcasestr(decryptionSelect, modeSelect);
    if (decr != NULL)
    {
      mode = MODE_DECRYPT;  
    }   
