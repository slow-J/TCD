...
bool qflag, Nflag, Qflag, Zflag, Dflag, inodeflag, devflag, hflag, Rflag;
...

{
  ...
  Dflag = qflag = Zflag = Nflag = Qflag = Rflag = hflag = Hflag = siflag = cflag = FALSE;
