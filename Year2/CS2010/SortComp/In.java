...
public final class In {
     ...
     */
    public boolean readBoolean() throws InputMismatchException{
        String s = readString();
        boolean returnValue = false;
        if (s.equalsIgnoreCase("true"))  returnValue = true;
        if (s.equalsIgnoreCase("false")) returnValue = false;
        if (s.equals("1"))               returnValue = true;
        if (s.equals("0"))               returnValue = false;
        scanner.nextLine();
        return returnValue;
